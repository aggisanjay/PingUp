...
const UserProfileInfo = ({user,posts,profileId,setShowEdit}) => {
  return (
    <div className='relative py-4 px-6 md:px-8 ng-white'>
        <div className='flex flex-col md:flex-row items-start gap-6'>
            ...
            <div className='w-full pt-16 md:pt-0 md:pl-36'>
                ...
                {/* if user is not on others profile that means he is opening his profile so we will give edit button */}
                 ...
                 {!profileId && <button className='flex items-center gap-2 border border-gray-300 hover:bg-gray-50 px-4 py-2 rounded-lg font-medium transition-colors mt-4 md:mt-0 cursor-pointer' onClick={()=>setShowEdit(true)}>
